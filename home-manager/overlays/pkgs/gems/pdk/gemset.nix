{
  ...
  facter = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "01k67xh4hzpik8sipgf5ycvqqb4pz9dvgk7jkngax8j6irj7v62p";
      type = "gem";
    };
    version = "4.2.1";
  };
  ...
  pdk = {
    dependencies = ["childprocess" "concurrent-ruby" "cri" "deep_merge" "diff-lcs" "facter" "ffi" "gettext-setup" "hitimes" "httpclient" "json-schema" "json_pure" "minitar" "pathspec" "tty-prompt" "tty-spinner" "tty-which"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0wbzwzak2xd88935x56gl677wg53c8988sjwnm12266ickvmd2dj";
      type = "gem";
    };
    version = "2.1.0";
  };
